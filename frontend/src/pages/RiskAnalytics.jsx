  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-20">
      <div className="flex justify-between items-end border-b border-slate-200 dark:border-slate-800 pb-6">
        <div>
          <h2 className="text-4xl font-black italic tracking-tighter text-slate-50 uppercase leading-none">Risk<br/>Intelligence</h2>
          <p className="text-slate-400 font-medium mt-2">AI-driven predictive models and city-wide risk assessments.</p>
        </div>
        <button className="flex items-center gap-2 px-6 py-4 bg-[#FF6B00] hover:bg-[#FF8C42] text-white font-black uppercase italic tracking-widest text-[10px] rounded-2xl shadow-xl shadow-orange-500/25 transition-all active:scale-95">
          <AlertTriangle size={18} /> Download Protocol Audit
        </button>
      </div>

      {!hasData ? (
        <div className="bg-[#111827] border border-slate-800 rounded-[2.5rem] p-16 text-center shadow-sm flex flex-col items-center ring-1 ring-slate-800">
          <div className="w-24 h-24 bg-[#FF6B00]/10 rounded-full flex items-center justify-center mb-8 ring-1 ring-[#FF6B00]/20">
            <Activity className="text-[#FF6B00] w-10 h-10 animate-pulse" />
          </div>
      ...
      <div className="bg-[#111827] rounded-[2.5rem] p-8 shadow-lg border border-slate-800 relative overflow-hidden h-[30rem] flex flex-col items-center justify-center text-center group">
        ...
        <div className="absolute top-1/4 left-1/3 w-80 h-80 bg-[#FF6B00]/20 rounded-full blur-[80px] mix-blend-screen animate-pulse"></div>
        <div className="absolute bottom-1/3 right-1/4 w-60 h-60 bg-[#FF8C42]/20 rounded-full blur-[60px] mix-blend-screen animate-pulse delay-700"></div>
        ...
        <div className="relative z-10 flex flex-col items-center bg-[#0B0F19]/80 px-10 py-12 rounded-[2rem] backdrop-blur-xl border border-slate-800 shadow-2xl">
          <Map size={56} className="text-[#FF6B00] mb-6 drop-shadow-[0_0_15px_rgba(255,107,0,0.5)]" />
